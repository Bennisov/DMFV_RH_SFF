...
// Thu Aug  8 15:55:39 2024 by ROOT version 6.30/04
// from TTree Delphes/Analysis tree
// found on file: DM.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3809;
   static constexpr Int_t kMaxTrack = 239;
   static constexpr Int_t kMaxTower = 542;
   static constexpr Int_t kMaxEFlowTrack = 239;
   static constexpr Int_t kMaxEFlowPhoton = 316;
   static constexpr Int_t kMaxEFlowNeutralHadron = 180;
...
#ifdef precuts_cxx
precuts::precuts(TTree *tree) : fChain(0) 
{
...
Int_t precuts::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t precuts::LoadTree(Long64_t entry)
{
...
void precuts::Show(Long64_t entry)
{
...
Int_t precuts::Cut(Long64_t entry)
{
